...
namespace Microsoft.Scripting.JavaScript
{
    public sealed class JavaScriptDataView : JavaScriptObject
    {
        ...
        public short GetInt8(uint byteOffset)
        {
            ...
            return (short)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset) }));
        }
        /// <summary>
        ...
        public byte GetUint8(uint byteOffset)
        {
            ...
            return (byte)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset) }));
        }
        /// <summary>
        ...
        public short GetInt16(uint byteOffset, bool littleEndian = false)
        {
            ...
            return (short)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        /// <summary>
        ...
        public ushort GetUint16(uint byteOffset, bool littleEndian = false)
        {
            ...
            return (ushort)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        /// <summary>
        ...
        public int GetInt32(uint byteOffset, bool littleEndian = false)
        {
            ...
            return eng.Converter.ToInt32(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        /// <summary>
        ...
        public uint GetUint32(uint byteOffset, bool littleEndian = false)
        {
            ...
            return (uint)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        /// <summary>
        ...
        public float GetFloat32(uint byteOffset, bool littleEndian = false)
        {
            ...
            return (float)eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        /// <summary>
        ...
        public double GetFloat64(uint byteOffset, bool littleEndian = false)
        {
            ...
            return eng.Converter.ToDouble(fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian) }));
        }
        ...
        public void SetInt8(uint byteOffset, short value)
        {
            ...
            fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromDouble(value) });
        }
        /// <summary>
        ...
        public void SetInt16(uint byteOffset, short value, bool littleEndian = false)
        {
            ...
            fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian), eng.Converter.FromDouble(value) });
        }
        /// <summary>
        ...
        public void SetInt32(uint byteOffset, int value, bool littleEndian = false)
        {
            ...
            fn.Call(this, new JavaScriptValue[] { eng.Converter.FromDouble(byteOffset), eng.Converter.FromBoolean(littleEndian), eng.Converter.FromInt32(value) });
        }
        /// <summary>
